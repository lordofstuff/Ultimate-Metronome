...
public class EventCreateObject implements Parcelable{
	...
	public EventCreateObject() {
		this(DEFAULT_NAME, DEFAULT_TEMPO, DEFAULT_VOLUME, DEFAULT_REPEATS, false, DEFAULT_PATTERN.clone(), DEFAULT_BEAT, DEFAULT_TIME_SIG_TOP, DEFAULT_TIME_SIG_BOTTOM, DEFAULT_EMPHASIS);
	}
